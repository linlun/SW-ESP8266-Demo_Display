...
/*
static const uint8_t bufferQrtech[SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH / 8] = {
		0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
		0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
		0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
		0xff,0xff,0x3,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x87,0xff,0xff,0xff,0xff,
		0xff,0xfc,0x1,0xff,0x80,0x3f,0xc0,0x7,0xf0,0x7,0xfc,0x1,0xfc,0x7e,0x3f,0xff,
		0xff,0xf8,0x0,0x7f,0x80,0x1f,0xc0,0x7,0xf0,0x7,0xf8,0x1,0xfc,0x7e,0x3f,0xff,
		0xff,0xf8,0x30,0x7f,0x8e,0x1f,0xe0,0xf,0xf0,0x7,0xf0,0x73,0xfc,0x7e,0x3f,0xff,
		0xff,0xf0,0xfc,0x3f,0x8f,0xf,0xfc,0x7f,0xf1,0xff,0xf0,0xff,0xfc,0x7e,0x3f,0xff,
		0xff,0xf1,0xfe,0x3f,0x8f,0xf,0xfc,0x7f,0xf1,0xff,0xf1,0xff,0xfc,0x7e,0x3f,0xff,
		0xff,0xe1,0xfe,0x3f,0x80,0x1f,0xfc,0x7f,0xf0,0x7,0xe1,0xff,0xfc,0x0,0x3f,0xff,
		0xff,0xe1,0xfe,0x1f,0x80,0x1f,0xfc,0x7f,0xf0,0x7,0xe1,0xff,0xfc,0x0,0x3f,0xff,
		0xff,0xe1,0xfe,0x3f,0x80,0x7f,0xfc,0x7f,0xf0,0x7,0xe1,0xff,0xfc,0x0,0x3f,0xff,
		0xff,0xf1,0xfe,0x3f,0x8c,0x7f,0xfc,0x7f,0xf1,0xff,0xf1,0xff,0xfc,0x7e,0x3f,0xff,
		0xff,0xf0,0xfc,0x3f,0x8c,0x3f,0xfc,0x7f,0xf1,0xff,0xf0,0xfb,0xfc,0x7e,0x3f,0xff,
		0xff,0xf8,0x78,0x7f,0x8e,0x1f,0xfc,0x7f,0xf0,0x7,0xf0,0x61,0xfc,0x7e,0x3f,0xff,
		0xff,0xf8,0x0,0x7f,0x8e,0x1f,0xfc,0x7f,0xf0,0x7,0xf8,0x0,0xfc,0x7e,0x3f,0xff,
		0xff,0xfc,0x0,0xff,0x8f,0xf,0xfc,0x7f,0xf0,0x7,0xfc,0x1,0xfc,0x7e,0x3f,0xff,
		0xff,0xff,0x1,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x87,0xff,0xff,0xff,0xff,
...
Adafruit_SSD1306 display(-1);//PIN_OLED_SCL,PIN_OLED_SDA);
...
void SendValue()
{
	if (currentTemp > currentSetTemp)
	{
		if (heater != false)
		{
			if (mqtt->getConnectionState() == eTCS_Connected)
					mqtt->publish(mqtt_client + "/Heater", "OFF"); // or publishWithQoS
		}
	...
	} else
	{
		...
		{
			if (mqtt->getConnectionState() == eTCS_Connected)
					mqtt->publish(mqtt_client + "/Heater", "ON"); // or publishWithQoS
		}
	...
	display.print(currentSetTemp);
	display.print((char)247);

	display.setTextSize(1);
	display.setCursor(0,56);

	//display.print("03h13m");
	display.display();
...
void init() {
	Wire.pins(PIN_OLED_SCL ,PIN_OLED_SDA);

	//Wire.pins(PIN_OLED_SDA ,PIN_OLED_SCL);
	...
	display.print("Now");
	display.clearDisplay();
	//display.drawBitmap(0,0,bufferQrtech, 128,22,BLACK, WHITE);
	...
	SendValueTimer.initializeMs(200, SendValue).start(); // every 20 seconds
...
//	display.setCursor(0,14);
	display.print("Now");
	display.fillCircle(display.width()/4, display.height()/4, 15, WHITE);
	display.fillCircle(display.width()/2, display.height()/2, 10, WHITE);
	display.setTextColor(WHITE);
	//display.print("This is a long text");
//	display.setTextSize(3);
//	display.setCursor(20,0);
	//currentTemp = m_GetTemp();
//	display.print(currentTemp);
